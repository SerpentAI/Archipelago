...
class DeadByDaylightKeymastersKeepOptions:
    deadbydaylight_play_style: DeadByDaylight_Play_Style


class DeadByDaylightGame(Game):
    name = "Dead By Daylight"
    platform = KeymastersKeepGamePlatforms.PC
    options_cls = DeadByDaylightKeymastersKeepOptions
    ...
    def play_style(self) -> Set[str]:
        return self.archipelago_options.deadbydaylight_play_style.value
...
# Archipelago Options
class DeadByDaylight_Play_Style(OptionSet):
    """
    Indicates if the player wants to play as Killer, Survivor, or Both.
    """
    valid_keys = [
        "Killer",
        "Survivor"
...
class KillersOwned(OptionSet):
    """
    Indicates what Killers the Player has/wants to use. Ignore this if you're not playing Killer.
    """
    valid_keys = [
        "Trapper",
        "Wraith",
...
class SurvivorsOwned(OptionSet):
    """
    Indicates what Survivors the player has, for perks-sake. Ignore this if you're not playing Survivor.
    """
    valid_keys = [
        "Laurie",
        "Ace",
