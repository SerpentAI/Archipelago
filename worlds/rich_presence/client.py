...
class DiscordRichPresenceContext(CommonClient.CommonContext):
    ...
    def game_to_title(self) -> str:
        ...
        mapping: Dict[str, str] = {
            ...
            "Cassette Beasts": "Cassette Beasts",
            ...
            "Garfield Kart - Furious Racing": "Garfield Kart: Furious Racing",
            ...
            "HITMAN World of Assassination": "HITMAN World of Assassination",
            "Hades": "Hades",
            ...
            "Isles Of Sea And Sky": "Isles Of Sea And Sky",
            ...
            "Mega Man X Command Mission": "Mega Man X: Command Mission",
            ...
            "MegaMan Battle Network 6": "Mega Man Battle Network 6",
            ...
            "Pokemon Black and White": "Pokémon Black and White",
            ...
            "SMW: Spicy Mycena Waffles": "Super Mario World [Waffles]",
            ...
            "Ship of Harkinian": "The Legend of Zelda: Ocarina of Time [Ship of Harkinian]",
            "Shivers": "Shivers",
            "Shovel Knight Pocket Dungeon": "Shovel Knight: Pocket Dungeon",
            "Signalis": "SIGNALIS",
            ...
            "Smushi Come Home": "Smushi Come Home",
            ...
            "Spyro 2": "Spyro 2: Ripto's Rage!",
            "Spyro 3": "Spyro: Year of the Dragon",
            ...
            "TCG Card Shop Simulator": "TCG Card Shop Simulator",
            "TOEM A Photo Adventure": "TOEM",
            "TUNIC": "TUNIC",
            "Terraria": "Terraria",
    ...
    def game_to_image_key(self) -> Optional[str]:
        ...
        # TODO: See if possible to switch to self-hosted images to bypass 300 asset limit
        # None are previously included covers that were temporarily removed to make room for more popular games
        mapping: Dict[str, str] = {
            "A Difficult Game About Climbing": None,
            ...
            "Air Delivery": None,
            "An Untitled Story": None,
            "Anodyne": "anodyne",
            "Another Crabs Treasure": "anothercrabstreasure",
            "Ape Escape 3": "apeescape3",
            ...
            "Castlevania: Dawn of Sorrow": "castlevaniadawnofsorrow",
            "Cat Quest": None,
            "Cave Story": None,
            "Cavern of Dreams": None,
            "Celeste (Open World)": "celeste",
            ...
            "Corn Kidz 64": None,
            "CrossCode": "crosscode",
            "Crypt of the NecroDancer": "cryptofthenecrodancer",
            "Crystal Project": "crystalproject",
            "Crystalis": "crystalis",
            "Cuphead": "cuphead",
            "DLCQuest": "dlcquest",
            "DOOM 1993": "doom1993",
            ...
            "DORONKO WANKO": None,
            "DREDGE": "dredge",
            "Dark Cloud 1": "darkcloud",
            "Dark Cloud 2": "darkcloud2",
            "Dark Souls II": "darksouls2",
            "Dark Souls III": "darksouls3",
            "Dark Souls Remastered": "darksoulsremastered",
            "Dead Rising Deluxe Remaster": "deadrisingdeluxeremaster",
            "Death's Door": "deathsdoor",
            "Deep Rock Galactic": "deeprockgalactic",
            "Devil May Cry 3": "devilmaycry3dantesawakening",
            ...
            "Donkey Kong Country": "donkeykongcountry",
            "Dragon Warrior": "dragonwarrior",
            "Duke Nukem 3D": "dukenukem3d",
            "Dungeon Clawler": None,
            "EarthBound": "earthbound",
            "Easy Delivery Co.": "easydeliveryco",
            "Ender Lilies": "enderlilies",
            "Enter The Gungeon": "enterthegungeon",
            "FF1 Pixel Remaster": "finalfantasypixelremaster",
            "FFPS": None,
            "FNaFW": None,
            "Factorio": "factorio",
            "Faxanadu": "faxanadu",
            ...
            "Gauntlet Legends": None,
            "Getting Over It": None,
            "Glover": "glover",
            "Golden Sun The Lost Age": "goldensunthelostage",
            "Grim Dawn": "grimdawn",
            "Guild Wars 2": None,
            "HITMAN World of Assassination": "hitmanworldofassassination",
            "Hades": "hades",
            "Hammerwatch": None,
            "Haste": "haste",
            "Hatsune Miku Project Diva Mega Mix+": "hatsunemikuprojectdivamegamix",
            "Here Comes Niko!": None,
            "Heretic": "heretic",
            "Hi-Fi RUSH": "hifirush",
            ...
            "Isles Of Sea And Sky": "islesofseaandsky",
            ...
            "Lego Batman: The Video Game": "legobatmanthevideogame",
            "Lego Star Wars: The Complete Saga": "legostarwarsthecompletesaga",
            "Lethal Company": "lethalcompany",
            "Lies Of P": "liesofp",
            "Lightning Returns: Final Fantasy XIII": "lightningreturnsfinalfantasy13",
            "Lil Gator Game": None,
            "Lingo 2": "lingo2",
            "Lingo": "lingo",
            ...
            "Mario Kart Double Dash": "mariokartdoubledash",
            "Medievil 2": "medievil2",
            "Medievil": "medievil",
            "Mega Man 2": "megaman2",
            "Mega Man 3": "megaman3",
            "Mega Man X Command Mission": "megamanxcommandmission",
            "Mega Man X": "megamanx",
            "Mega Man X2": "megamanx2",
            "Mega Man X3": "megamanx3",
            "Mega Man Zero 3": "megamanzero3",
            "MegaMan Battle Network 3": "megamanbattlenetwork3",
            "MegaMan Battle Network 6": "megamanbattlenetwork6",
            "MetroCUBEvania": None,
            ...
            "Nodebuster": None,
            "Noita": "noita",
            "Oblivion Remastered": "theelderscrolls4oblivionremastered",
            ...
            "Paper Mario: The Thousand-Year Door": "papermariothethousandyeardoor",
            "Parkitect": "parkitect",
            ...
            "Plants vs. Zombies Replanted": "plantsvszombiesreplanted",
            "Pokemon Black and White": "pokemonblackandwhite",
            ...
            "Pokemon Platinum": "pokemonplatinum",
            "Pokemon Red and Blue": "pokemonredandblue",
            "Pokemon Stadium": "pokemonstadium",
            "Portal 2": "portal2",
            ...
            "Ratchet & Clank 3": "ratchetandclankupyourarsenal",
            "Ratchet & Clank": "ratchetandclank",
            ...
            "Super Smash Bros. Melee": "supersmashbrosmelee",
            "Supraland": "supraland",
            "Symphony of the Night": "symphonyofthenight",
            "System Shock 2": "systemshock2",
            "TCG Card Shop Simulator": "tcgcardshopsimulator",
            "TOEM A Photo Adventure": "toem",
            "TUNIC": "tunic",
            "Terraria": "terraria",
            ...
            "Ty the Tasmanian Tiger 2": "tythetasmaniantiger2",
            "Ty the Tasmanian Tiger 3": "tythetasmaniantiger3",
            "Ty the Tasmanian Tiger": "tythetasmaniantiger",
            "Tyrian": None,
            "UFO 50": "ufo50",
            "ULTRAKILL": "ultrakill",
            "Undertale": "undertale",
            "Unfair Flips": "unfairflips",
            "VVVVVV": "vvvvvv",
            "Valheim": "valheim",
            ...
            "Yu-Gi-Oh! Dungeon Dice Monsters": None,
            "Yu-Gi-Oh! Forbidden Memories": "yugiohforbiddenmemories",
            "Yu-Gi-Oh! GX: Duel Academy": None,
