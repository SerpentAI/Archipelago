...
class ZorkGrandInquisitorItems(enum.Enum):
    ...
    HOTSPOT_PAST_JACKS_DOOR = "Hotspot: Past Jack's Door"
    ...
    HOTSPOT_UMBRELLA_FLOWERS = "Hotspot: Umbrella Flowers"
...
class ZorkGrandInquisitorLocations(enum.Enum):
    ...
    ITS_GOT_TO_CATCH_SOMEHOW = "It's Got to Catch, Somehow"
    ...
    TAKE_A_STEP_BACK_BEFORE_IT_LANDS = "Take a Step Back Before it Lands"
    ...
    WHY_YOU_NEVER_TALK_TO_BROG = "Why You Never Talk to Brog?"
