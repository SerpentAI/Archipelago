...
from .data.entrance_data import Entrance, EntranceRule, EntranceRuleData
...
from .data.song_data import song_data, TromboneChampSongData
...
def items_with_tag(tag: TromboneChampTags) -> Set[str]:
    items: Set[str] = set()
...
def locations_with_tag(tag: TromboneChampTags) -> Set[str]:
