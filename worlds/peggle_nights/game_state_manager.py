...
class GameStateManager:
    ...
    def are_quick_play_levels_unlocked(self) -> bool:
        ...
        try:
            ...
            return (maximum_stage_cleared, maximum_level_cleared) == (12, 4)
        except Exception:
            return False
    ...
    def unlock_quick_play_levels(self) -> bool:
        ...
        try:
            self.process.write_int(self.maximum_stage_cleared_address, 12)
            self.process.write_int(self.maximum_level_cleared_address, 4)
